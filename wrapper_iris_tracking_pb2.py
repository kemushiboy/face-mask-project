...
# source: wrapper_iris_tracking.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='wrapper_iris_tracking.proto',
  package='mediapipe',
  syntax='proto2',
...
_WRAPPERIRISTRACKING = _descriptor.Descriptor(
  name='WrapperIrisTracking',
  full_name='mediapipe.WrapperIrisTracking',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='landmarks', full_name='mediapipe.WrapperIrisTracking.landmarks', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rect', full_name='mediapipe.WrapperIrisTracking.rect', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='detection', full_name='mediapipe.WrapperIrisTracking.detection', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WRAPPERIRISTRACKING.fields_by_name['landmarks'].message_type = _NORMALIZEDLANDMARKLIST
...
DESCRIPTOR.message_types_by_name['WrapperIrisTracking'] = _WRAPPERIRISTRACKING
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

Landmark = _reflection.GeneratedProtocolMessageType('Landmark', (_message.Message,), {
  'DESCRIPTOR' : _LANDMARK,
  '__module__' : 'wrapper_iris_tracking_pb2'
...
WrapperIrisTracking = _reflection.GeneratedProtocolMessageType('WrapperIrisTracking', (_message.Message,), {
  'DESCRIPTOR' : _WRAPPERIRISTRACKING,
  '__module__' : 'wrapper_iris_tracking_pb2'
  # @@protoc_insertion_point(class_scope:mediapipe.WrapperIrisTracking)
  })
_sym_db.RegisterMessage(WrapperIrisTracking)
